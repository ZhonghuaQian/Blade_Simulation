...
Point(2) = {hd, edge, start-0.35, lce};
Point(3) = {hd, edge, start-0.3, lce};
Point(4) = {hd, edge, start-0.05, lce};
Point(5) = {hd, edge, start, lce};
Point(6) = {hd, edge, start+0.25, lce};
Point(7) = {hd, edge, start+0.3, lce};
Point(8) = {hd, edge, start+0.55, lce};
Point(9) = {hd, edge, start+0.6, lce};
...
Point(12) = {hd, -edge, start-0.35, lce};
Point(13) = {hd, -edge, start-0.3, lce};
Point(14) = {hd, -edge, start-0.05, lce};
Point(15) = {hd, -edge, start, lce};
Point(16) = {hd, -edge, start+0.25, lce};
Point(17) = {hd, -edge, start+0.3, lce};
Point(18) = {hd, -edge, start+0.55, lce};
Point(19) = {hd, -edge, start+0.6, lce};
